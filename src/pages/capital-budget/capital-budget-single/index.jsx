...
export default function CapitalBudgetSingle() {
  ...
  // compute equipment age from year of installation if available, fallback to equipment_life
  const equipmentAge = (() => {
          ...
          <div className="flex items-start gap-5">
            ...
            <div className="flex-1">
              ...
              {/* <div className="grid grid-cols-3 gap-3 mt-8">
                {list.map((item, index) => (
                  <Card key={index} item={item} bg="#F6F6F8" />
                ))}
              </div> */}
              <div className="space-y-2 mt-5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <DetailCard
                    title="Status"
                    value={`${data?.data?.equipment_status.replaceAll("_", " ")}`}
                  />
                  ...
                  <DetailCard
                    title="Design Type"
                    value={data?.data?.specification?.design_type}
                  />
